...
1.  Download the `.dmg` file from the [latest release](https://github.com/tejass21/Vcode-IDE/releases/latest)
...
1.  Download the `.exe` installer from the [latest release](https://github.com/tejass21/Vcode-IDE/releases/latest)
